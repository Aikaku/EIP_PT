...
**Q01.** 다음은 Java 코드에 대한 문제이다. 아래 코드를 확인하여 알맞는 출력값을 작성하시오.
...
**Q02.** 다음은 파이썬에 대한 문제이다. 아래 코드를 확인하여 알맞는 출력값을 작성하시오.
...
**Q03.** 아래의 employee 테이블과 project 테이블을 참고하여 SQL 명령어에 알맞는 출력값을 작성하시오.
...
**Q04.** 다음은 운영체제 페이지 순서를 참고하여 할당된 프레임의 수가 3개일 때 LRU 알고리즘의 페이지 부재 횟수를 작성하시오.

페이지 참조 순서: 7 0 1 2 0 3 0 4 2 3 0 3 2 1 2 0 1 7 0 1

---

**Q05.** 다음은 네트워크 취약점에 대한 문제이다. 아래 내용을 보고 알맞는 용어를 작성하시오.
...
**Q06.** 다음은 GoF 디자인 패턴과 관련된 문제이다. 괄호 안에 알맞는 용어를 작성하시오.
...
**Q07.** 다음은 C언어에 대한 문제이다. 아래 코드를 확인하여 알맞는 출력값을 작성하시오.
...
**Q08.** 다음은 무결성 제약조건에 대한 문제이다. 아래 표에서 어떠한 무결성을 위반하였는지 작성하시오.

| <u>StudentID</u> | Name  | Age | Major            |
|-----------------|-------|-----|-----------------|
...
**Q09.** 다음은 URL 구조에 관한 문제이다. 아래 보기의 순서대로 URL에 해당하는 번호를 작성하시오.
...
**Q10.** 다음은 파이썬에 대한 문제이다. 아래 코드를 확인하여 알맞는 출력값을 작성하시오.
...
**Q11.** 다음은 Java 코드에 대한 문제이다. 아래 코드를 확인하여 알맞는 출력값을 작성하시오.
...
**Q12.** 다음은 C언어에 대한 문제이다. 아래 코드를 확인하여 알맞는 출력값을 작성하시오.
...
**Q13.** 다음은 테스트 커버리지에 대한 문제이다. 아래 내용에 알맞는 답을 보기에서 골라 작성하시오.
...
**Q14.** 아래는 UML 클래스의 관계에 관한 문제이다. 보기를 보고 알맞는 관계를 선택하여 작성하시오.

```
          차
        / | \
       /  |  \
  타이어  바퀴  엔진          ← (1) 차와 타이어/바퀴/엔진의 관계

          차
          ↑
        / | \
       /  |  \
    버스  택시  승용차         ← (2) 버스/택시/승용차와 차의 관계

  텔레비전 --→ 리모콘          ← (3) 텔레비전과 리모콘의 관계
```
...
**Q15.** 다음은 데이터베이스에 관한 문제이다. 아래 내용을 읽고 알맞는 답을 보기에서 찾아 골라 작성하시오.
...
**Q16.** 다음은 C언어에 대한 문제이다. 아래 코드를 확인하여 알맞는 출력값을 작성하시오.
...
**Q17.** 다음 아래 내용을 보고 알맞는 용어를 작성하시오. (3글자로 작성)
...
**Q18.** 다음은 Java 코드에 대한 문제이다. 아래 코드를 확인하여 알맞는 출력값을 작성하시오.
...
**Q19.** 다음은 Java 코드에 대한 문제이다. 아래 코드를 확인하여 알맞는 출력값을 작성하시오.
...
**Q20.** 다음은 네트워크에 대한 문제이다. 아래 내용을 보고 알맞는 용어를 보기에서 골라 작성하시오.
...
| Q04 | 12 |
| Q05 | 스머프(Smurf) 공격 |
| Q06 | 행위(Behavioral) 패턴 |
| Q07 | 20 |
| Q08 | 개체 무결성(Entity Integrity) |
| Q09 | query:④, path:③, scheme:①, authority:②, fragment:⑤ |
| Q10 | 45 |
| Q11 | 52 |
| Q12 | 312 |
| Q13 | ①ㅂ(문장), ②ㄹ(분기), ③ㄱ(조건) |
| Q14 | (1)ㄴ 연관, (2)ㄷ 일반화, (3)ㄱ 의존 |
| Q15 | (1)ㄴ 외래키, (2)ㄹ 후보키, (3)ㄷ 대체키, (4)ㄱ 슈퍼키 |
| Q16 | 1 |
| Q17 | VPN |
| Q18 | 101 |
| Q19 | B0 |
| Q20 | ㄹ (Ad-hoc Network) |
