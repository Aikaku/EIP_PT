...
**Q01.** 다음은 파일 구조와 관련된 설명이다. 설명을 읽고 괄호 안에 들어갈 가장 알맞은 용어를 작성하시오.
...
**Q02.** 다음은 데이터베이스 릴레이션의 구성 요소 중 하나에 대한 설명이다. 설명을 읽고 보기에서 알맞은 기호를 골라 작성하시오.
...
**Q03.** 다음은 정보보안 관련 문제이다. 아래 내용을 보고 알맞는 단어를 작성하시오.
...
**Q04.** 스케줄링 알고리즘에 관한 다음 설명을 읽고 (1)과 (2)에 알맞은 스케줄링 알고리즘의 명칭을 각각 쓰시오.
...
**Q05.** 다음은 Java의 문제이다. 아래 코드를 보고 알맞는 출력값을 작성하시오.
...
**Q06.** 다음은 IP 주소와 서브넷 마스크에 관한 문제이다. 주어진 정보를 참고하여 괄호 안에 들어갈 알맞은 값을 쓰시오.

호스트의 IP 주소가 223.13.234.132이고 서브넷 마스크가 255.255.255.192일 때 다음 물음에 답하시오.

- 이 호스트가 속한 네트워크 주소는 223.13.234.( ① )이다.
- 이 네트워크에서 사용 가능한 호스트 수는 ( ② )개이다. (단, 네트워크 주소와 브로드캐스트 주소는 제외한다.)

---

**Q07.** 다음은 디자인 패턴에 관한 문제이다. 아래 내용을 보고 알맞는 단어를 작성하시오.
...
**Q08.** 다음은 웹 데이터 교환 방식에 관한 문제이다. 아래 설명을 읽고 괄호 안에 들어갈 알맞은 용어를 작성하시오.
...
**Q09.** 다음은 Java언어의 문제이다. 아래 코드를 보고 알맞는 출력값을 작성하시오.
...
**Q10.** 다음은 Java언어의 문제이다. 아래 코드를 보고 알맞는 출력값을 작성하시오.
...
**Q11.** 다음 아래 제어 흐름 그래프가 분기 커버리지를 만족하기 위한 테스팅 순서를 쓰시오.
...
**Q12.** 다음은 C언어의 문제이다. 아래 코드를 보고 알맞는 출력값을 작성하시오.
...
**Q13.** 라운드로빈(RR) 방식을 이용하고 아래 내용을 참고하여 평균 대기시간을 구하시오.

시간 할당량은 4ms이고 컨텍스트 스위칭 시간은 무시한다.
...
**Q14.** 다음은 C언어의 문제이다. 아래 코드를 보고 알맞는 출력값을 작성하시오.
...
**Q15.** 다음은 Java언어의 문제이다. 아래 코드를 보고 알맞는 출력값을 작성하시오.
...
**Q16.** 다음은 C언어의 문제이다. 아래 코드를 보고 알맞는 출력값을 작성하시오.
...
**Q17.** 다음은 Python언어의 문제이다. 아래 코드를 보고 알맞는 출력값을 작성하시오.
...
**Q18.** 다음은 C언어의 문제이다. 아래 코드를 보고 알맞는 출력값을 작성하시오.
...
**Q19.** 다음은 TCP 통신 과정에서 발생할 수 있는 보안 취약점에 대한 설명이다. 이를 이용한 공격 기법의 명칭을 쓰시오.
...
**Q20.** 다음 테이블에서 πTTL(employee)에 대한 연산 결과 값을 작성하시오.
...
| Q04 | (1) SJF (Shortest Job First), (2) SRT (Shortest Remaining Time) |
| Q05 | BB |
| Q06 | ①128, ②62 |
| Q07 | 프록시(Proxy) 패턴 |
| Q08 | AJAX (Asynchronous JavaScript and XML) |
| Q09 | 19 |
| Q10 | 5P |
| Q11 | TC1: ①→②→③→④→⑤→⑥→⑦ / TC2: ①→②→④→⑤→⑥→① |
| Q12 | 2 그리고 3 |
