...
### Section 118_기출 따라잡기_문제8 (비트 논리 연산자)
...
### 319 break와 continue 기출체크2 (※ C 코드 포함 주의)
...
### 318 제어문 - Java 기출체크2 (3의 배수이자 2의 배수)
...
### 03 Java 문제2 - 예제1 (생성자 오버라이딩 + super)
...
### 기출 따라잡기_문제5 (동일 코드: 323 Java의 클래스1 기출체크1)

(동일 코드: 323 Java의 클래스1 기출체크1)

### 323 Java의 클래스1 기출체크2 (static 변수)
...
### 324 Java의 클래스2 기출체크1 (상속 + super 생성자)
...
### 문제 02 / Section 124_기출 따라잡기_문제1 (다형성 오버라이딩)

(동일 코드: 문제 02 와 Section 124_기출 따라잡기_문제1 동일)
...
### 문제 21 (오버라이딩 연쇄 + 재귀 StackOverflow 주의)
...
(동일 코드: 문제49 와 동일 - conn1.count() 1번 추가 차이)
...
### Section 124_기출 따라잡기_문제3 (재귀 오버라이딩)
...
### Section 123_기출 따라잡기_문제4 (생성자 + this + 재귀)
...
### Section 127_기출 따라잡기_문제2 (예외처리 + finally)
...
### Section 127_기출 따라잡기_문제3 (람다 + 예외처리)
...
(동일 코드: 문제 33 - 객체 배열 참조 스왑)

### 문제32 → 6번 클래스/상속 섹션에 포함
...
| 파일명 | 출력값 |
|---|---|
| 02 Java 문제 - 예제1 | `Chicken is animal`(줄바꿈)`Zoo` |
| 02 Java 문제1 - 예제1 / 323 Java의 클래스1 | `19` |
| 03 Java 문제 - 예제1 | `e1 l2 i3 g4 a5 ` |
| 03 Java 문제2 - 예제1 | `AED7` |
| 311 데이터 입출력 - Java 예상체크1 | 입력 의존 (a+b 출력) |
| 311 데이터 입출력 - Java | 입력 의존 |
| 318 제어문 - Java 기출체크1 | `0+1+2+3+4+5=15` |
| 318 제어문 - Java 기출체크2 | `996` |
| 319 break와 continue 기출체크1 | `30` |
| 319 break와 continue 기출체크2 (C코드) | `46` |
| 323 Java의 클래스1 기출체크1 / 기출 따라잡기_문제5 | `2200` |
| 323 Java의 클래스1 기출체크2 | `10`(줄)`11`(줄)`10`(줄)`20` |
| 324 Java의 클래스2 기출체크1 | `a=10` |
| 324 Java의 클래스2 | `5P` |
| 326 Java의 활용 기출체크1 | `Vehicle name : Spark` |
| Section 118_기출 따라잡기_문제8 | `7` |
| Section 123_기출 따라잡기_문제2 | `0 1 2 3 ` |
| Section 123_기출 따라잡기_문제4 | `61` |
| Section 124_기출 따라잡기_문제1 / 문제 02 | `child` |
| Section 124_기출 따라잡기_문제3 | `1` |
| Section 127_기출 따라잡기_문제2 | `101` |
| Section 127_기출 따라잡기_문제3 | `19` |
| 기출 따라잡기_문제1 | `00001010` |
| 기출 따라잡기_문제12 | `3`(줄)`1`(줄)`45`(줄)`50`(줄)`89` |
| 기출 따라잡기_문제2 / 문제 27 | (아래 상세 참조) |
| 기출 따라잡기_문제3 / 311 예상체크1 | 입력 의존 |
| 기출 따라잡기_문제5 / 323기출체크1 | `2200` |
| 기출 따라잡기_문제6 | `110` |
| 기출 따라잡기_문제8 | `24513` |
| 문제 02 / Section 124_문제1 | `child` |
| 문제 07 | `positive` |
| 문제 20 | `true`(줄)`false`(줄)`true`(줄)`true` |
| 문제 21 | `BDC D` (상세: BDCD) |
| 문제 22 | `4` |
| 문제 23 | `5` |
| 문제 27 / 기출_문제2 | (2차원 배열 출력 상세 참조) |
| 문제 31 | 순서 불규칙 (Thread - `miles traveled : 1` ~ `miles traveled : 99`) |
| 문제 33 / 문제30 | `1a3b3` |
| 문제 35 / 문제37 | `AB` |
| 문제 39 / 문제47 | `B0` |
| 문제10 | `29`(줄)`53`(줄)`35` |
...
### 02 Java 문제1 - 예제1 (= 323 Java의 클래스1)
...
### 319 break와 continue 기출체크2 (C 언어 코드)
...
### 323 Java의 클래스1 기출체크1 (= 기출 따라잡기_문제5)
...
### 문제 23 (= Section 124_기출 따라잡기_문제3 유사)
