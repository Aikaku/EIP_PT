...
| 2 | 문제 03 — 비트 AND | `2` |
| 3 | 문제 04 — 비트 시프트 | `26` |
| 4 | 문제 05 — for 루프 후 i | `10 55` |
| 5 | 문제 06 — 1~100 합 | `5050` |
| 6 | 문제 07 — 짝수 합 | `30` |
| 7 | 문제 08 — 슬라이싱 조합 | `engneing` |
| 8 | 문제 09 — % 포맷팅 | `REMEMBE R AND STR` |
| 9 | 문제 10 — 앞뒤 3글자 (입력: `abcdefgh`) | `abcfgh` |
| 10 | 문제 11 — 두 번째 글자 모으기 | `Seynaau` |
| 11 | 문제 15 — 세트 교집합 len | `2` |
| 12 | 문제 16 — enumerate + 딕셔너리 | `NameError` (resultf 오타) |
| 13 | 문제 20 — lambda + map | `[101, 102, 103, 104, 105]` |
| 14 | 문제 21 — if + lambda | `[101, 102, 103, 104, 105]` |
| 15 | 문제 23 — 클래스 add | `6` |
| 16 | 문제 18 — 기본값 매개변수 | `a = 20 b = 2` |
| 17 | 문제 19 — type() | `45` |
| 18 | 문제 25 — 뒤집기 | `3` |
| 19 | 문제 27 (버그) — 트리 재귀 | `5` |
| 20 | 문제 27 (정상) — 트리 재귀 | `13` |
| 21 | 문제 28 (버그) — 패턴 카운트 | `ab0 ca1` |
| 22 | 문제 28 (정상) — 패턴 카운트 | `ab3 ca3` |
...
' ' + S + K + I + D + D + P = ' SKIDDP'
```
문제 11과 차이: 문제 11은 `'S'`로 시작 + `i[1]`(두 번째 글자), 문제 24는 `' '`로 시작 + `i[0]`(첫 번째 글자).
